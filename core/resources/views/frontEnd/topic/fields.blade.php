            ...
            @if (
                ...
                @elseif($customField->type == 11)
                    ...
                    @if ($CF_Youtube_id != '')
                        <div class="col-sm-12">
                            ...
                            <div class="custom-field-value card mb-3 py-2 px-3 rounded-2">
                                {{-- Youtube Video --}}
                                <iframe allowfullscreen style="height: 600px;width: 100%"
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="custom-field-value card mb-3 py-2 px-3 rounded-2">
                            <video width="100%" height="450" controls>
                                <source src="{{ URL::to('uploads/topics/' . $cf_saved_val) }}" type="video/mp4">
                ...
                @elseif($customField->type == 9)
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="custom-field-value card mb-3 py-2 px-3 rounded-2">
                            ...
                            @if ($ext == 'mp3' || $ext == 'wav')
                                <audio controls>
                                    <source src="{{ URL::to('uploads/topics/' . $cf_saved_val) }}" type="audio/mpeg">
                                    Your browser does not support the audio
                                    element.
                                </audio>
                            @else
                                <a href="{{ URL::to('uploads/topics/' . $cf_saved_val) }}" target="_blank">
                                    <span class="badge">
                ...
                @elseif($customField->type == 8)
                    ...
                    <div class="col-sm-12">
                        <h5 class="custom-field-title">{!! $cf_title !!}</h5>
                        <div class="custom-field-value card mb-3 py-2 px-3 rounded-2">
                            <a href="{{ URL::to('uploads/topics/' . $cf_saved_val) }}" class="galelry-lightbox">
                                <img style="max-height: 256px;width: auto"
                                    src="{{ URL::to('uploads/topics/' . $cf_saved_val) }}"
                                    alt="{{ $cf_title }} - {{ $title }}"
                                    title="{{ $cf_title }} - {{ $title }}" class="rounded-2">
                            </a>
                        </div>
                    </div>
